...
- [Skill Cards](#skill-cards)
  ...
  - [Lightning Bomb](#lightning-bomb)
  - [Thunder Core](#thunder-core)
  - [Matrix Drone](#matrix-drone)
  - [Firewheel](#firewheel)
  - [Phantom Dart](#phantom-dart)
  - [Mortar](#mortar)
...
|-----------|------|--------|--------|
| Volley Missile | — | Normal | Flame Missile +1, DMG -15% |
| Flame Boost | — | Normal | Flame Missile DMG +50% |
| Explosion Spread | — | Normal | Explosion range +30% |
| Impact Reinforcement | Chain | Normal | Launches 3 small missiles on hit |
| Ignition | Chain | Normal | Main missiles inflict [Burn] on hit |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Beam Amplification | — | Normal | Main beam DMG +50% |
| Stable Energy | — | Normal | Beam duration +50% |
| Beam Reflection | — | Normal | Main beam reflection +1, DMG -20% per reflection |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Field Amplification | — | Normal | Distortion Field DMG +50% |
| Field Duration | — | Normal | Field duration +30% |
| Field Expansion | — | Normal | Distortion Field range +25% |
| Disruption Force | Chain | Normal | Inflicts 1 stack of Disruption on hit |
| Random Disturbance | Chain | Normal | Has chance to teleport targets back on hit |
| Final Blast | — | ★ Special | Causes explosion DMG when the Field ends |
| Stasis Field | — | ★ Special | Each time enemies take damage from Distortion Field, Slow effect +10% (MAX: 90%) |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Electro Boost | — | Normal | Lightning Bomb DMG +50% |
| Electro Strike | — | Normal | Lightning Bomb +1, DMG -15% |
| Electro Expansion | — | Normal | Lightning Bomb explosion range +20% |
| Bounce Boost | Chain | Normal | Lightning Bomb bounces +1, DMG -15% |
| Trap Matrix | Chain | Normal | Upon hitting the first enemy, Lightning Bomb releases Electric Matrix with additional DMG for 2s |
| Electric Chain Surge | — | ★ Special | Lightning Bomb releases 5 High-voltage shocks to nearby enemies |
| Electro Interference | — | ★ Special | Lightning Bomb cooldown speed +50%, explosion and Electro Matrix inflict [Paralyze] effect |
...
| Drone Mirage | Combo | Normal | Hitting an enemy with the Lightning Bomb summons an Echo Drone |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Continuous Strike | — | Normal | Thunder Core +1, DMG -15% |
| Swift Strike | — | Normal | Thunder Core attack range +30%, DMG +30% |
| Lightning Boost | — | Normal | Thunder Core DMG +50% |
| Lightning Paralysis | Chain | Normal | Enemies hit by Thunder Core receive [Paralyze] effect |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Drone Assault | — | Normal | Matrix Drone DMG +50% |
| Rapid Barrage | — | Normal | Matrix Drone attack count +2 |
| Dense Matrix | — | Normal | Matrix Drone +2, DMG -15% |
| Contact Pulse | Chain | Normal | Drone releases 1 Pulse Wave on first hit |
| Echo Drone | Chain | Normal | Drone clones a level 1 Echo Drone on kill (MAX: 1) |
| Drone Evolution II | — | ★ Special | Matrix Drone evolves to level 2 after 3 attacks |
| Drone Mutation II | — | ★ Special | After 2 launches per round, deploy level 2 Matrix Drone for subsequent launches |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Firewheel Boost | — | Normal | Firewheel DMG +50% |
| Size Boost | — | Normal | Firewheel size +25% |
| Duration Extension | — | Normal | Firewheel duration +20% and DMG +20% |
| Mini Firewheel | Chain | Normal | Firewheel summons 2 Mini Fireballs every 3s |
| Flame Trail | Chain | Normal | Firewheel leaves a Flame Trail for 2s during flight |
| Smart Acceleration | — | ★ Special | Firewheel DMG +60%, move speed +30% |
| Hold the Ground | — | ★ Special | Firewheel stays for an additional 10s after it ends |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Dart Boost | — | Normal | Phantom Dart DMG +50% |
| Dart Salvo | — | Normal | Phantom Dart +1, DMG -15% |
| Penetrator Upgrade | — | Normal | Phantom Dart DMG +30%, Penetration +1 |
| Primary Splitting | Chain | Normal | Upon hitting the first enemy, Phantom Dart splits into 2 Small darts, with a 20% chance to split into 2 more |
| Explosive Dart | Chain | Normal | Phantom Dart explodes on hit |
| Power Penetration | — | ★ Special | Phantom Dart penetration +3, knockback +100% |
| Weak Spot Strike | — | ★ Special | Phantom Dart DMG increases with target HP (MAX: 150%) |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Powerful Blast | — | Normal | Mortar DMG +50% |
| Multiple Blast | — | Normal | Mortar bullet +1, DMG -15% |
| Impact Enhancement | — | Normal | Mortar knockback +50%, DMG +30% |
| Shotgun Barrage | Chain | Normal | After Mortar fires, it launches 5 penetrating Shotgun Shells |
| Landmine | Chain | Normal | Upon explosion, Mortar bullet leaves 2 Landmines in the explosion area |
| Massive Explosion | — | ★ Special | Mortar explosion range +70% |
| Central Blast | — | ★ Special | Mortar deals an additional high-energy explosion to the center area |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| Laser Boost | — | Normal | Focus Laser DMG +50% |
| High-Frequency Laser | — | Normal | Focus Laser DMG interval -20% |
| Damage Increase | Chain | Normal | Focus Laser deals increasing damage to the same target (MAX: 200%) |
| Efficient Laser | — | Normal | Focus Laser duration +20%, DMG +20% |
| Laser Refraction | Chain | Normal | When the Laser hits a target, it generates Refracted Lasers with +2 refractions |
| Charge Multiplier | — | ★ Special | Focus Laser cooldown speed +50% |
| Laser Penetration | — | Normal | All Focus Lasers inflict [Vulnerable] effect to targets |
...
| Disruptive Field | Combo | Normal | Targets hit by Focus Laser generate a small Distortion Field |
...
| Card Name | Type | Rarity | Effect |
|-----------|------|--------|--------|
| High Power Field | — | Normal | Traction Field DMG +50% |
| Wide Field | — | Normal | Traction Field range +25% |
| Extended Field | — | Normal | Traction Field flight distance +30% |
| Phase Siphon | Chain | Normal | When Traction Field hits the first enemy, a portal is created to teleport enemies to the location where the field disappears for 3s |
| Gravity Hole | Chain | Normal | Creates a Gravity Hole continuously pulling enemies for 5s after the Traction Field disappears |
| Extended Pull | — | ★ Special | The further the Traction Field flies, the larger the range |
| Field Amplification | — | ★ Special | Traction Field DMG +80%, pulling force +100% |
...
| Field Disruption | Combo | Normal | Traction Field inflicts [Disruption] effect on hit |
